...
@SuppressWarnings("serial")  
    ...
    public class Menu_Nivel2 extends JFrame {     
...
setIconImage(Toolkit.getDefaultToolkit().getImage(Menu_Nivel2.class.getResource("/Images/arroba.jpg")));
...
lblBack.setIcon(new ImageIcon(Menu_Nivel2.class.getResource("/Images/Infotec.jpg")));
...
getContentPane().add(lblBack);       
       ...
       mntmCliente.setIcon(new ImageIcon(Menu_Nivel2.class.getResource("/Images/icone_cliente2.png")));
       ...
       mntmProduto.setIcon(new ImageIcon(Menu_Nivel2.class.getResource("/Images/icone_produtosOrig.jpg")));
       ...
       mntmFornecedor.setIcon(new ImageIcon(Menu_Nivel2.class.getResource("/Images/Fornecedor.jpg")));
       ...
       mnNewMenu.setIcon(new ImageIcon(Menu_Nivel2.class.getResource("/Images/funcionario.png")));
       mnInicio.add(mnNewMenu);
       
       JMenuItem mntmPagamento = new JMenuItem("Pagamento");
       mntmPagamento.setIcon(new ImageIcon(Menu_Nivel2.class.getResource("/Images/coins2.png")));
       ...
       mntmCadastrarFuncionrio.setIcon(new ImageIcon(Menu_Nivel2.class.getResource("/Images/users.png")));
       ...
       mntmFuncionrioDoMs.setIcon(new ImageIcon(Menu_Nivel2.class.getResource("/Images/funcionario.png")));
...
//Referênte a NOVA ENTRADA do menu VENDA  
       ...
       menuItemNovaEntrada.setIcon(new ImageIcon(Menu_Nivel2.class.getResource("/Images/shopcart2.png")));
       ...
       mntmRelatrioDeVenda.setIcon(new ImageIcon(Menu_Nivel2.class.getResource("/Images/invoice2.png")));
...
//Refêrente ao Pedido de Compra do MENU Compra  
     ...
     menuItemPedidoDeCompra.setIcon(new ImageIcon(Menu_Nivel2.class.getResource("/Images/Sobre.jpg")));
     menuCompra.add(menuItemPedidoDeCompra);         
     
     JMenuItem mntmCrticasESugestes = new JMenuItem("Cr\u00EDticas e Sugest\u00F5es");
     mntmCrticasESugestes.setIcon(new ImageIcon(Menu_Nivel2.class.getResource("/Images/Mail_add2.png")));
     ...
     ImageIcon image = new ImageIcon(Menu_Nivel2.class.getResource("/Images/Infotec.jpg"));
     }     
    
    public static void main(String[] args) throws IOException, SQLException, exception {     
       Menu_Nivel2 teste = new Menu_Nivel2();     
