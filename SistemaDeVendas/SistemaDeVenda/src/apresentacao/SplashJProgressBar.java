...
private void criandoComponentes() {
         ...
         * jLabelSplashImage
         */
        ImageIcon imageIcon = new ImageIcon(getClass().getResource("/Images/Splach.png"));
        jLabelSplashImage.setIcon(new ImageIcon(SplashJProgressBar.class.getResource("/Images/Splach.png")));
        /**
         ...
         * Setando parametros da variavel jProgressBarSistema
         */
        jLabelTextoCarregamento.setForeground(Color.LIGHT_GRAY);
        jLabelTextoCarregamento.setFont(new Font("Verdana", Font.ITALIC, 13));
        jLabelTextoCarregamento.setText("Loading ...");
        jLabelTextoCarregamento.setBounds(328, 285, 80, 20);
        /**
         * Adicionando o jProgressBarSistema a classe SplashJProgressBar
         */
