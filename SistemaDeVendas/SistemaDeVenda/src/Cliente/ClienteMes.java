...
public class ClienteMes extends JDialog {
	...
	public static void main(String[] args) {
		try {
			ClienteMes dialog = new ClienteMes();
	...
	public ClienteMes() {
		...
		lblParabns.setFont(new Font("Segoe Script", Font.BOLD, 35));
		...
		btnGerarFolha.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				try{  
	                ...
	                String FileJasper = "C:\\Users\\Luhkas\\Documents\\Relatorio_Java\\Relatorios_InfoTec\\RelatorioVenda2.jasper";  
